...
resultat = resultat[0]
resultat_str:str  = resultat[0]
resultat_str.replace("'","")
resultat_str.replace("\\","")
resultat_str.replace("\\","")

# Abre un archivo en modo escritura
with open(r'C:\Users\joant\OneDrive\Stucom\MasterIA\BigData\Exercicis\Players_database\nba_db_information.txt', 'w') as file:
    file.write(resultat_str)